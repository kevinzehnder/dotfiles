...
-- buffer handling
--[[ lvim.key.normal_mode["<S-h>"] = ":bprevious<cr>", ]]
--[[ lvim.key.normal_mode["<S-l>"] = ":bnext<cr>", ]]
lvim.keys.normal_mode["<leader>bq"] = ":bp <BAR> confirm bd #<cr>"
lvim.keys.normal_mode["<leader>bQ"] = ":%bd|e#|confirm bd #<cr>"
lvim.keys.normal_mode["<leader>o"] = ":Telescope buffers<cr>"
...
lvim.keys.normal_mode["<Leader>vs"] = ":silent !code %:p<cr>" -- open current file in vscode
