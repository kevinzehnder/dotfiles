...
gitsigns.setup {
  ...
  on_attach = function(bufnr)
    ...
    map('n', '<leader>ga', gs.select_hunk, {desc="select hunk"})
    ...
    map('n', '<leader>gD', function() gs.diffthis('~') end, {desc="diffthis ~"})
    map('n', '<leader>gd', gs.toggle_deleted, {desc="toggle deleted"})
    map('n', '<leader>gh', gs.toggle_linehl, {desc="toggle line HL"})
